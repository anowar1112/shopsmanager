...
router.get('/', requireAuth, requirePermission('customer:read'), asyncHandler(async (req, res) => {
...
router.post('/', requireAuth, requirePermission('customer:create'), asyncHandler(async (req, res) => {
...
router.patch('/:id', requireAuth, requirePermission('customer:update'), asyncHandler(async (req, res) => {
