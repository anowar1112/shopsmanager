...
router.get('/', requireAuth, requirePermission('dashboard:operational'), asyncHandler(async (req, res) => {
...
router.post('/:id/read', requireAuth, requirePermission('dashboard:operational'), asyncHandler(async (req, res) => {
...
router.post('/read-all', requireAuth, requirePermission('dashboard:operational'), asyncHandler(async (req, res) => {
